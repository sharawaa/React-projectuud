...
const data = [
...

  {
    ...
    description:
      "Tips and Tricks lets you jump right in and learn how to be productive with Visual Studio Code. Youll become familiar with its powerful editing, code intelligence, and source code control features and learn useful keyboard shortcuts. This topic goes pretty fast and provides a broad overview",
    category: "TUT",
  },
  {
